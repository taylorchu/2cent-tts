...
ADD https://github.com/taylorchu/2cent-tts/releases/download/v0.1.0/2cent.gguf 2cent.gguf
ADD https://github.com/taylorchu/2cent-tts/releases/download/v0.1.0/tokenizer.json tokenizer.json
ADD https://github.com/taylorchu/2cent-tts/releases/download/v0.1.0/tts-http-server tts-http-server
